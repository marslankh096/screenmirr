package  com.sid.testscreenmirr.webcast.service.helper
...
class NotificationHelper(context: Context) {
    companion object {
        private const val CHANNEL_STREAM = " com.sid.testscreenmirr.webcast.NOTIFICATION_CHANNEL_START_STOP"
        private const val CHANNEL_ERROR = " com.sid.testscreenmirr.webcast.NOTIFICATION_CHANNEL_ERROR"
    }
    ...
    fun createNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notificationManager.deleteNotificationChannel(" com.sid.testscreenmirr.webcast.service.NOTIFICATION_CHANNEL_01")
    ...
    fun showErrorNotification(appError: AppError) {
        ...
        val builder = NotificationCompat.Builder(applicationContext, CHANNEL_ERROR)
            ...
            .setLargeIcon(AppCompatResources.getDrawable(applicationContext, R.drawable.ic_notifiicon)?.toBitmap())
            .setSmallIcon(R.drawable.ic_notifiicon)
