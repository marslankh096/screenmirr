...
import com.sid.testscreenmirr.databinding.ToastSlowConnectionBinding
...
import  com.sid.testscreenmirr.webcast.data.state.AppStateMachine
import  com.sid.testscreenmirr.webcast.data.state.AppStateMachineImpl
...
class AppService : Service() {
    ...
    private fun checkForSlowClients(clients: List<HttpClient>) {
        ...
        if (slowClients.containsAll(currentSlowConnections).not()) {
            ...
            val drawable = AppCompatResources.getDrawable(applicationContext, R.drawable.ic_share_black)
