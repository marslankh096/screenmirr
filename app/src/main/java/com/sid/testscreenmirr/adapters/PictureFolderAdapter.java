...
public class PictureFolderAdapter extends RecyclerView.Adapter<PictureFolderAdapter.FolderHolder> {
    ...
    public PictureFolderAdapter(ArrayList<ImagesFolderItems> folders, Activity folderContx, itemClickListener listen, String fileType) {
    ...
    public void onBindViewHolder(@NonNull FolderHolder holder, int position) {
        ...
        holder.folderPic.setOnClickListener(v -> {
            if (fileType.equals("Audios")) {
                ...
                IntertitialAdController.getInstance().showAdmobInterstitialFullApp(folderContx, () -> {
                    listenToClick.onPicClicked(folder.getPath(), folder.getFolderName());
                });
            }
